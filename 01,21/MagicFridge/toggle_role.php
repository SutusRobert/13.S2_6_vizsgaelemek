...
// Admin rang nem módosítható
if ($row['role'] === 'admin') {
    header("Location: households.php?error=Az admin rang nem módosítható.");
    exit;
}

// Rang hozzáadása/eltávolítása:
// - ha alap felhasználó → sima tag
// - ha tag → alap felhasználó
