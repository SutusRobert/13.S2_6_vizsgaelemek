<?php $__env->startSection('title','Custom recipe - MagicFridge'); ?>
        ...
        <div class="side-stack">
          ...
          <div class="note">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
              ...
              <a class="btn btn-mini" href="<?php echo e(route('recipes.index', ['hid' => (int)($hid ?? 0)])); ?>">🍳 Recipes</a>
      ...
      <div class="card" style="padding:22px;">
        <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:12px; flex-wrap:wrap;">
          ...
          <div style="display:flex; gap:10px; flex-wrap:wrap;">
            <a class="btn btn-secondary" href="<?php echo e(route('recipes.index', ['hid' => (int)($hid ?? 0)])); ?>">Back</a>
          </div>
        </div>

        <form method="post" action="<?php echo e(route('recipes.own.store')); ?>" class="mt-3" enctype="multipart/form-data" onsubmit="return validateIngredients()">
          <?php echo csrf_field(); ?>
        ...
        <textarea name="instructions"
          ...
          <div class="two-col">
            <div class="form-group">
              ...
              <input id="titleInput" type="text" name="title" placeholder="e.g. Cottage cheese pasta" value="<?php echo e(old('title')); ?>" required>
            </div>
          ...
          <div style="display:flex; gap:10px; flex-wrap:wrap; margin-top:18px;">
            ...
            <a href="<?php echo e(route('recipes.index', ['hid' => (int)($hid ?? 0)])); ?>" class="btn btn-secondary">Undo</a>
          </div>
        </form>
      </div>
    </div>
...
<script>
 ...
 const SAMPLE_RECIPES = [
  ...
  window.addEventListener('DOMContentLoaded', () => {
    ...
    const oldAmounts = <?php echo json_encode(old('amounts', []), 512) ?>;
    const oldUnits   = <?php echo json_encode(old('units', []), 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sutus\OneDrive\Dokumentumok\GitHub\13.S2_6_vizsgaelemek\02.24\MagicFridge\resources\views/recipes/own_create.blade.php ENDPATH**/ ?>