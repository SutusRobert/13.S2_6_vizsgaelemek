...
class InventoryController extends Controller
{
    ...
    private function ensureDefaultHousehold(int $userId): void
    {
        ...
        if ($fullName === '') {
            ...
            $fullName = (string)($u->full_name ?? ($u->name ?? 'Felhasználó'));
        }

        $householdName = trim($fullName) !== '' ? ($fullName . ' háztartása') : 'Háztartás';
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('inventory.list', ['hid' => $hid])->with('success', 'Termék hozzáadva.');
    }
