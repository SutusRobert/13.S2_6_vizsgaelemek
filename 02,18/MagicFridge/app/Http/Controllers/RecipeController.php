...
class RecipeController extends Controller
{
    ...
    private function apiSearch(string $query, int $limit = 50): array
    {
        ...
        foreach ($meals as $m) {
            ...
            // listában csak cache fordítás, remote nélkül
    ...
    public function show(Request $request, int $id)
    {
        ...
        $titleHu = $this->huTitle((string)($meal['strMeal'] ?? 'Recept'), true);
    ...
    public function addMissingToShopping(Request $request, int $id)
    {
        ...
        $recipeTitleHu = $this->huTitle((string)($meal['strMeal'] ?? 'Recept'), true);
        ...
        for ($i = 1; $i <= 20; $i++) {
            ...
            $nameHu = $this->huTitle($ingName, true);
