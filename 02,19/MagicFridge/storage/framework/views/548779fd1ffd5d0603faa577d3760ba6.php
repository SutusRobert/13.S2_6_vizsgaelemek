<?php $__env->startSection('title', 'Üzenetek – MagicFridge'); ?>
        ...
        <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="card mt-3" style="padding:16px;">
            ...
            <?php if($isInventory && $hid > 0): ?>
              <div class="mt-2">
                <a class="btn" href="<?php echo e(route('inventory.list', ['hid' => $hid])); ?>">Készlet megnyitása</a>
              </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\udvar\Documents\GitHub\13.S2_6_vizsgaelemek\02,19\MagicFridge\resources\views/messages/index.blade.php ENDPATH**/ ?>